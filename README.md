...
The full writeup, including all supporting tables, sits in [`docs/Final_Report.docx`](docs/Final_Report.docx). This README covers the process and highlights from that report.
